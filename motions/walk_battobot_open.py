...
def walk_battobot_open(com_vel, n_steps, ss_duration, ds_duration, com_weight, external_run=True, guessFile=None, saveFile=None):
...
if __name__ == "__main__":
    ...
    robot, ddp, sol, params = walk_battobot_open(0.7, 4, 0.4, 0.01, 0)
