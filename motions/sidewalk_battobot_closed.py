...
def sidewalk_battobot_closed(com_vel, n_steps, ss_duration, ds_duration, com_weight, external_run=True, guessFile=None, saveFile=None):
    walkParams = params.SideWalkBattobotParams('closed')
...
if __name__ == "__main__":
    ...
    robot, ddp, sol, params = sidewalk_battobot_closed(0.4, 4, 0.4, 0.01, 0)
