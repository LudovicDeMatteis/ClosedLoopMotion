...
def stairs_battobot_closed(com_vel, n_steps, ss_duration, ds_duration, stairs_height, external_run=True, guessFile=None, saveFile=None):
    walkParams = params.StairsBattobotParams('closed')
...
if __name__ == "__main__":
    ...
    robot, ddp, sol, params = stairs_battobot_closed(0.7, 4, 0.4, 0.01, 0)
